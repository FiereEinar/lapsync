              ...
              <View className='flex flex-col gap-3 mt-2 mb-2'>
                {registrations.slice(0, 3).map((reg: any) => {
                  ...
                  return (
                    <View
                      key={reg._id}
                      className='flex-row items-center p-3 bg-muted/20 border border-border rounded-xl'
                    >
              ...
              {upcomingEvents.length === 0 ? (
                ...
                upcomingEvents.map((event: any) => {
                  ...
                  if (event.raceCategories) {
                    spotsLeft = event.raceCategories.reduce(
                      (acc: number, cat: any) =>
                        acc + (cat.slots - (cat.registeredCount || 0)),
                      0,
                    );
                  }
                  const loc =
                    ...
                    >
                      ...
                      <View className='flex-1 pr-2'>
                        ...
                        <View className='flex-row items-center gap-2'>
                          ...
                          <Text
                            className='text-muted-foreground text-[10px] uppercase tracking-wider font-bold'
                            numberOfLines={1}
                          >
                            {loc}
                          </Text>
                          <Text className='text-muted-foreground text-[10px] uppercase tracking-wider font-bold ml-1'>
                            • {spotsLeft} spots
                          </Text>
                        </View>
                      </View>
                      <TouchableOpacity
                        ...
                        className='flex-row items-center bg-primary/10 px-3 py-1.5 rounded-md flex-shrink-0'
                      >
                        <Text className='text-primary text-xs font-bold mr-1'>
                          View
                        </Text>

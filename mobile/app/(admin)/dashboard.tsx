      ...
      <ScrollView contentContainerStyle={{ padding: 20 }}>
                    ...
                    <View className="flex-1 pr-4">
                      ...
                      <View className="flex-row items-center gap-4">
                        <View className="flex-row items-center">
                          <Calendar size={14} color="hsl(0, 0%, 70%)" style={{ marginRight: 6 }} />
                          <Text className="text-muted-foreground text-xs">{date}</Text>
                        </View>
                        <View className="flex-row items-center flex-1 pr-2">
                          <MapPin size={14} color="hsl(0, 0%, 70%)" style={{ marginRight: 6 }} />
        ...
        <Card className="mb-8">
          ...
          <CardContent className="flex flex-col gap-3">
            <TouchableOpacity onPress={() => setModalVisible(true)} className="bg-primary rounded-md py-3 flex-row justify-center items-center shadow-sm">
              <Plus size={18} color="hsl(0, 0%, 100%)" />
              <Text className="text-primary-foreground font-semibold ml-2 text-base">Create New Event</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => router.push("/(admin)/participants")} className="border border-input bg-background rounded-md py-3 flex-row justify-center items-center shadow-sm">
